...
export default function Formulario({setFrase}){
    ...
    <div className="container">
        <p className="text-xl text-center">Comienza a escribir para buscar Gifs</p>   
        <form onSubmit={enviaForm} className="py-2 w-6/12 mx-auto">
            <div className="relative">
                <div className="flex absolute inset-y-0 left-0 items-center pl-2 pointer-events-none">
                    <svg aria-hidden="true" className="w-6 h-6 text-gray-500 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                </div>
